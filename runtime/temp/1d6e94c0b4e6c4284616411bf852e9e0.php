<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:65:"E:\WWW\mytest\github\lvyou/application/admin\view\rule\index.html";i:1541772903;s:66:"E:\WWW\mytest\github\lvyou\application\admin\view\public\base.html";i:1541769015;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="Hui-article">
    <article class="cl pd-20">
        <div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l">
            <a href="javascript:;" onclick="open_page('添加权限节点', '<?php echo url("rule/addRule"); ?>', '', '400')" class="btn btn-primary radius"><i class="Hui-iconfont"></i> 添加权限节点</a></span> <span class="r">共有数据：<strong><?php echo count($list)?></strong> 条</span> </div>
